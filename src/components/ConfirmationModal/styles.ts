...
export const ConfirmationModalTitleClassNames = 'text-xl font-semibold'

export const ConfirmationModalTextClassNames = 'text-sm text-gray-700'

export const ConfirmationModalButtonContainerClassNames =
